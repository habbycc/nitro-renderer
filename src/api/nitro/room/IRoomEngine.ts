...
export interface IRoomEngine extends INitroManager {
  ...
  setRoomInstanceRenderingCanvasMask(
    roomId: number,
    canvasId: number,
    flag: boolean,
  ): void;
  ...
  getRoomInstanceRenderingCanvasOffset(
    roomId: number,
    canvasId?: number,
  ): Point;
