...
export interface IRoomCreator {
  ...
  updateRoomInstancePlaneVisibility(
    roomId: number,
    wallVisible: boolean,
  ...
  updateRoomObjectFloorHeight(
    roomId: number,
    objectId: number,
    height: number,
  ): boolean;
  updateRoomObjectFloorExpiration(
    roomId: number,
    objectId: number,
    expires: number,
  ): boolean;
  updateRoomObjectWallExpiration(
    roomId: number,
    objectId: number,
    expires: number,
  ): boolean;
  ...
  updateRoomObjectUserFlatControl(
    roomId: number,
    objectId: number,
    level: string,
  ): boolean;
  updateRoomObjectUserEffect(
    roomId: number,
    objectId: number,
    effectId: number,
    delay?: number,
  ): boolean;
  updateRoomObjectUserGesture(
    roomId: number,
    objectId: number,
    gestureId: number,
  ): boolean;
  updateRoomObjectUserPetGesture(
    roomId: number,
    objectId: number,
    gesture: string,
  ): boolean;
  updateRoomObjectUserPosture(
    roomId: number,
    objectId: number,
    type: string,
    parameter?: string,
