export class RoomObjectVariable {
  ...
  public static FURNITURE_PURCHASER_FIGURE: string =
    'furniture_purchaser_figure';
  ...
  public static FIGURE_EXPERIENCE_TIMESTAMP: string =
    'figure_experience_timestamp';
  ...
  public static FURNITURE_CUSTOM_VARIABLES: string =
    'furniture_custom_variables';
  public static FURNITURE_AUTOMATIC_STATE_INDEX: string =
    'furniture_automatic_state_index';
  public static FURNITURE_ALWAYS_STACKABLE: string =
    'furniture_always_stackable';
  public static FURNITURE_DISABLE_PICKING_ANIMATION: string =
    'furniture_disable_picking_animation';
  public static FURNITURE_DATA_FORMAT: string = 'furniture_data_format';
  public static FURNITURE_UNIQUE_SERIAL_NUMBER: string =
    'furniture_unique_serial_number';
  public static FURNITURE_UNIQUE_EDITION_SIZE: string =
  ...
  public static FURNITURE_CRACKABLE_TARGET: string =
    'furniture_crackable_target';
  ...
  public static FURNITURE_GUILD_CUSTOMIZED_GUILD_ID: string =
    'furniture_guild_customized_guild_id';
  public static FURNITURE_GUILD_CUSTOMIZED_ASSET_NAME: string =
    'furniture_guild_customized_asset_name';
  public static FURNITURE_GUILD_CUSTOMIZED_COLOR_1: string =
    'furniture_guild_customized_color_1';
  public static FURNITURE_GUILD_CUSTOMIZED_COLOR_2: string =
    'furniture_guild_customized_color_2';
  public static FURNITURE_STATE_UPDATE_TIME: string =
    'furniture_state_update_time';
  public static FURNITURE_SELECTION_DISABLED: string =
    'furniture_selection_disabled';
  ...
  public static FURNITURE_ALLOWED_DIRECTIONS: string =
  ...
  public static FURNITURE_EXPIRTY_TIMESTAMP: string =
    'furniture_expiry_timestamp';
  public static FURNITURE_REAL_ROOM_OBJECT: string =
    'furniture_real_room_object';
  public static FURNITURE_IS_STICKIE: string = 'furniture_is_stickie';
  public static FURNITURE_BRANDING_IMAGE_STATUS: string =
    'furniture_branding_image_status';
  public static FURNITURE_BRANDING_IMAGE_URL: string =
    'furniture_branding_image_url';
  public static FURNITURE_BRANDING_URL: string = 'furniture_branding_url';
  public static FURNITURE_BRANDING_OFFSET_X: string =
    'furniture_branding_offset_x';
  public static FURNITURE_BRANDING_OFFSET_Y: string =
    'furniture_branding_offset_y';
  public static FURNITURE_BRANDING_OFFSET_Z: string =
    'furniture_branding_offset_z';
  public static FURNITURE_BRANDING_IS_ANIMATED: string =
    'furniture_branding_is_animated';
  public static FURNITURE_BADGE_IMAGE_STATUS: string =
    'furniture_badge_image_status';
  public static FURNITURE_BADGE_ASSET_NAME: string =
    'furniture_badge_asset_name';
  public static FURNITURE_BADGE_VISIBLE_IN_STATE: string =
    'furniture_badge_visible_in_state';
  public static FURNITURE_ALPHA_MULTIPLIER: string =
  ...
  public static FURNITURE_ROOM_BACKGROUND_COLOR_HUE: string =
    'furniture_room_background_color_hue';
  public static FURNITURE_ROOM_BACKGROUND_COLOR_SATURATION: string =
    'furniture_room_background_color_saturation';
  public static FURNITURE_ROOM_BACKGROUND_COLOR_LIGHTNESS: string =
    'furniture_room_background_color_lightness';
  ...
  public static FURNITURE_IS_VARIABLE_HEIGHT: string =
    'furniture_is_variable_height';
  public static FURNITURE_VOTE_MAJORITY_RESULT: string =
    'furniture_vote_majority_result';
  public static FURNITURE_VOTE_COUNTER_COUNT: string =
    'furniture_vote_counter_count';
  public static FURNITURE_SOUNDBLOCK_RELATIVE_ANIMATION_SPEED: string =
    'furniture_soundblock_relative_animation_speed';
  public static FURNITURE_MANNEQUIN_NAME: string = 'furniture_mannequin_name';
  public static FURNITURE_MANNEQUIN_GENDER: string =
    'furniture_mannequin_gender';
  public static FURNITURE_MANNEQUIN_FIGURE: string =
    'furniture_mannequin_figure';
  public static FURNITURE_HIGHSCORE_SCORE_TYPE: string =
    'furniture_highscore_score_type';
  public static FURNITURE_HIGHSCORE_CLEAR_TYPE: string =
    'furniture_highscore_clear_type';
  public static FURNITURE_HIGHSCORE_DATA_ENTRY_COUNT: string =
    'furniture_highscore_data_entry_count';
  public static FURNITURE_HIGHSCORE_DATA_ENTRY_BASE_USERS_: string =
    'furniture_highscore_data_entry_base_users_';
  public static FURNITURE_HIGHSCORE_DATA_ENTRY_BASE_SCORE_: string =
  ...
  public static FURNITURE_PLANETSYSTEM_DATA: string =
    'furniture_planetsystem_data';
  ...
  public static ROOM_FLOOR_HOLE_UPDATE_TIME: string =
  ...
  public static FURNITURE_FRIENDFURNI_ENGRAVING: string =
    'furniture_friendfurni_engraving_type';
