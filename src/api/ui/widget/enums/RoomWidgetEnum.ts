export class RoomWidgetEnum {
  ...
  public static FURNI_PET_PACKAGE_WIDGET: string =
  ...
  public static CUSTOM_USER_NOTIFICATION: string =
    'RWE_CUSTOM_USER_NOTIFICATION';
  public static FURNI_ACHIEVEMENT_RESOLUTION_ENGRAVING: string =
    'RWE_FURNI_ACHIEVEMENT_RESOLUTION_ENGRAVING';
