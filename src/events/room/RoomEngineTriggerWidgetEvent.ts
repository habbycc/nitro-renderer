...
export class RoomEngineTriggerWidgetEvent extends RoomEngineObjectEvent {
  ...
  public static OPEN_FURNI_CONTEXT_MENU: string =
    'RETWE_OPEN_FURNI_CONTEXT_MENU';
  public static CLOSE_FURNI_CONTEXT_MENU: string =
    'RETWE_CLOSE_FURNI_CONTEXT_MENU';
  ...
  public static REQUEST_CLOTHING_CHANGE: string =
    'RETWE_REQUEST_CLOTHING_CHANGE';
  public static REQUEST_PLAYLIST_EDITOR: string =
    'RETWE_REQUEST_PLAYLIST_EDITOR';
  ...
  public static REQUEST_MONSTERPLANT_SEED_PLANT_CONFIRMATION_DIALOG: string =
    'ROWRE_REQUEST_MONSTERPLANT_SEED_PLANT_CONFIRMATION_DIALOG';
  public static REQUEST_PURCHASABLE_CLOTHING_CONFIRMATION_DIALOG: string =
    'ROWRE_REQUEST_PURCHASABLE_CLOTHING_CONFIRMATION_DIALOG';
  public static REQUEST_BACKGROUND_COLOR: string =
    'RETWE_REQUEST_BACKGROUND_COLOR';
  public static REQUEST_MYSTERYBOX_OPEN_DIALOG: string =
    'RETWE_REQUEST_MYSTERYBOX_OPEN_DIALOG';
  public static REQUEST_EFFECTBOX_OPEN_DIALOG: string =
    'RETWE_REQUEST_EFFECTBOX_OPEN_DIALOG';
  public static REQUEST_MYSTERYTROPHY_OPEN_DIALOG: string =
    'RETWE_REQUEST_MYSTERYTROPHY_OPEN_DIALOG';
  public static REQUEST_ACHIEVEMENT_RESOLUTION_ENGRAVING: string =
    'RETWE_REQUEST_ACHIEVEMENT_RESOLUTION_ENGRAVING';
  public static REQUEST_ACHIEVEMENT_RESOLUTION_FAILED: string =
    'RETWE_REQUEST_ACHIEVEMENT_RESOLUTION_FAILED';
  public static REQUEST_FRIEND_FURNITURE_CONFIRM: string =
    'RETWE_REQUEST_FRIEND_FURNITURE_CONFIRM';
  public static REQUEST_FRIEND_FURNITURE_ENGRAVING: string =
    'RETWE_REQUEST_FRIEND_FURNITURE_ENGRAVING';
  public static REQUEST_BADGE_DISPLAY_ENGRAVING: string =
    'RETWE_REQUEST_BADGE_DISPLAY_ENGRAVING';
  public static REQUEST_HIGH_SCORE_DISPLAY: string =
    'RETWE_REQUEST_HIGH_SCORE_DISPLAY';
  public static REQUEST_HIDE_HIGH_SCORE_DISPLAY: string =
