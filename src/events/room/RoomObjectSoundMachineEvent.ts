...
export class RoomObjectSoundMachineEvent extends RoomEngineObjectEvent {
  ...
  public static SOUND_MACHINE_SWITCHED_ON: string =
    'ROSM_SOUND_MACHINE_SWITCHED_ON';
  public static SOUND_MACHINE_SWITCHED_OFF: string =
    'ROSM_SOUND_MACHINE_SWITCHED_OFF';
