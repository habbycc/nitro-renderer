...
export class RoomObjectWidgetRequestEvent extends RoomObjectEvent {
  ...
  public static CLOSE_FURNI_CONTEXT_MENU: string =
    'ROWRE_CLOSE_FURNI_CONTEXT_MENU';
  ...
  public static MYSTERYTROPHY_OPEN_DIALOG: string =
    'ROWRE_MYSTERYTROPHY_OPEN_DIALOG';
  public static ACHIEVEMENT_RESOLUTION_OPEN: string =
    'ROWRE_ACHIEVEMENT_RESOLUTION_OPEN';
  public static ACHIEVEMENT_RESOLUTION_ENGRAVING: string =
    'ROWRE_ACHIEVEMENT_RESOLUTION_ENGRAVING';
  public static ACHIEVEMENT_RESOLUTION_FAILED: string =
    'ROWRE_ACHIEVEMENT_RESOLUTION_FAILED';
  public static FRIEND_FURNITURE_CONFIRM: string =
    'ROWRE_FRIEND_FURNITURE_CONFIRM';
  public static FRIEND_FURNITURE_ENGRAVING: string =
    'ROWRE_FRIEND_FURNITURE_ENGRAVING';
  public static BADGE_DISPLAY_ENGRAVING: string =
    'ROWRE_BADGE_DISPLAY_ENGRAVING';
  public static HIGH_SCORE_DISPLAY: string = 'ROWRE_HIGH_SCORE_DISPLAY';
  public static HIDE_HIGH_SCORE_DISPLAY: string =
