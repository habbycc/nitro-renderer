...
export class RoomSessionConfirmPetBreedingResultEvent extends RoomSessionEvent {
  public static RSPFUE_CONFIRM_PET_BREEDING_RESULT: string =
    'RSPFUE_CONFIRM_PET_BREEDING_RESULT';
  ...
  constructor(k: IRoomSession, _arg_2: number, _arg_3: number) {
    super(
      RoomSessionConfirmPetBreedingResultEvent.RSPFUE_CONFIRM_PET_BREEDING_RESULT,
      k,
    );
