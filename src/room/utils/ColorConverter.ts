...
export class ColorConverter {
  ...
  public static getHex(x: any) {
    return isNaN(x)
      ? '00'
      : ColorConverter.HEX_DIGITS[(x - (x % 16)) / 16] +
          ColorConverter.HEX_DIGITS[x % 16];
  }
    ...
    if (_local_3 > 0) {
      ...
      if (_local_14 * 6 < 1) {
        ...
        if (_local_14 * 2 < 1) {
          ...
          if (_local_14 * 3 < 2) {
            _local_5 =
              _local_13 + (_local_12 - _local_13) * 6 * (2 / 3 - _local_14);
          } else {
            _local_5 = _local_13;
          }
        }
      ...
      if (_local_15 * 6 < 1) {
        ...
        if (_local_15 * 2 < 1) {
          ...
          if (_local_15 * 3 < 2) {
            _local_6 =
              _local_13 + (_local_12 - _local_13) * 6 * (2 / 3 - _local_15);
          } else {
            _local_6 = _local_13;
          }
        }
      ...
      if (_local_16 * 6 < 1) {
        ...
        if (_local_16 * 2 < 1) {
          ...
          if (_local_16 * 3 < 2) {
            _local_7 =
              _local_13 + (_local_12 - _local_13) * 6 * (2 / 3 - _local_16);
          } else {
            _local_7 = _local_13;
          }
        }
