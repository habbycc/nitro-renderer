...
export class RoomManager
  ...
  implements IRoomManager, IRoomInstanceContainer
{
  ...
  constructor(
    ...
    this.events.addEventListener(
      ...
      this.onRoomContentLoadedEvent,
    );
    this.events.addEventListener(
      RoomContentLoadedEvent.RCLE_FAILURE,
      this.onRoomContentLoadedEvent,
    );
    this.events.addEventListener(
      RoomContentLoadedEvent.RCLE_CANCEL,
      this.onRoomContentLoadedEvent,
    );
  }
  ...
  public createRoomObjectAndInitalize(
    ...
    const object = instance.createRoomObject(
      objectId,
      1,
      type,
      category,
    ...
    if (this._visualizationFactory) {
      const visualizationInstance =
        this._visualizationFactory.getVisualization(visualization);
      ...
      const visualizationData = this._visualizationFactory.getVisualizationData(
        assetName,
        visualization,
