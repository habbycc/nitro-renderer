...
export class HabboWebTools {
  ...
  public static logEventLog(data: string): void {
    try {
      ...
      NitroLogger.log(
        'External interface not working, failed to log event log.',
      );
    }
  }
  ...
  public static open(url: string): void {
    try {
      if (LegacyExternalInterface.available) {
        ...
        NitroLogger.log(
          'External interface not available. Could not request to open: ' + url,
        );
      }
    } catch (e) {
      NitroLogger.log(
        'External interface not working. Could not request to open: ' + url,
      );
    }
  }
  ...
  public static roomVisited(roomId: number): void {
    try {
      if (LegacyExternalInterface.available) {
        ...
        NitroLogger.log(
          'External interface not available. Could not store last room visit.',
        );
      }
    } catch (e) {
      NitroLogger.log(
        'External interface not working. Could not store last room visit.',
      );
    }
  }
  ...
  public static openMinimail(target: string): void {
    try {
      if (LegacyExternalInterface.available) {
        ...
        NitroLogger.log(
          'External interface not available. Could not open minimail.',
        );
      }
    } catch (e) {
      NitroLogger.log(
        'External interface not working. Could not open minimail.',
      );
    }
  }
  ...
  public static openNews(): void {
    try {
      if (LegacyExternalInterface.available) {
        ...
        NitroLogger.log(
          'External interface not available. Could not open news.',
        );
      }
    } catch (e) {
  ...
  public static closeNews(): void {
    try {
      if (LegacyExternalInterface.available) {
        ...
        NitroLogger.log(
          'External interface not available. Could not close news.',
        );
      }
    } catch (e) {
  ...
  public static openAvatars(): void {
    try {
      if (LegacyExternalInterface.available) {
        ...
        NitroLogger.log(
          'External interface not available. Could not open avatars.',
        );
      }
    } catch (e) {
      NitroLogger.log(
        'External interface not working. Could not open avatars.',
      );
    }
  }
  ...
  public static openRoomEnterAd(): void {
    try {
      if (LegacyExternalInterface.available) {
        ...
        NitroLogger.log(
          'External interface not available. Could not open roomenterad.',
        );
      }
    } catch (e) {
      NitroLogger.log(
        'External interface not working. Could not open roomenterad.',
      );
    }
  }
  ...
  public static updateFigure(figure: string): void {
    try {
      if (LegacyExternalInterface.available) {
        ...
        NitroLogger.log(
          'External interface not available. Could not update figure.',
        );
      }
    } catch (e) {
      NitroLogger.log(
        'External interface not working. Could not update figure.',
      );
    }
  }
}
