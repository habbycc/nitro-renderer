...
export class NitroMessages implements IMessageConfiguration {
  ...
  private registerEvents(): void {
    ...
    // GAMES
    this._events.set(
      IncomingHeader.ACHIEVEMENTRESOLUTIONCOMPLETED,
      AchievementResolutionCompletedMessageEvent,
    );
    this._events.set(
      IncomingHeader.ACHIEVEMENTRESOLUTIONPROGRESS,
      AchievementResolutionProgressMessageEvent,
    );
    this._events.set(
      IncomingHeader.ACHIEVEMENTRESOLUTIONS,
      AchievementResolutionsMessageEvent,
    );
    ...
    this._events.set(
      IncomingHeader.GAME_CENTER_GAME_LIST,
      GameListMessageEvent,
    );
    this._events.set(IncomingHeader.GAMESTATUSMESSAGE, GameStatusMessageEvent);
    this._events.set(
      IncomingHeader.GAME_CENTER_ACHIEVEMENTS,
      UserGameAchievementsMessageEvent,
    );
    this._events.set(
      IncomingHeader.GAME_CENTER_STATUS,
      Game2AccountGameStatusMessageEvent,
    );
    this._events.set(
      IncomingHeader.GAMEACHIEVEMENTS,
      GameAchievementsMessageEvent,
    );
    this._events.set(IncomingHeader.GAMEINVITE, GameInviteMessageEvent);
    this._events.set(
      IncomingHeader.JOINEDQUEUEMESSAGE,
      JoinedQueueMessageEvent,
    );
    this._events.set(
      IncomingHeader.JOININGQUEUEFAILED,
      JoiningQueueFailedMessageEvent,
    );
  ...
  private registerComposers(): void {
    ...
    this._composers.set(
      OutgoingHeader.ACCEPTGAMEINVITE,
      AcceptGameInviteMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.GAMEUNLOADEDMESSAGE,
      GameUnloadedMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.GETGAMEACHIEVEMENTSMESSAGE,
      GetGameAchievementsMessageComposer,
    );
    this._composers.set(OutgoingHeader.GAMES_LIST, GetGameListMessageComposer);
    this._composers.set(
      OutgoingHeader.GETGAMESTATUSMESSAGE,
      GetGameStatusMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.GETUSERGAMEACHIEVEMENTSMESSAGE,
      GetUserGameAchievementsMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.JOINQUEUEMESSAGE,
      JoinQueueMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.LEAVEQUEUEMESSAGE,
      LeaveQueueMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.RESETRESOLUTIONACHIEVEMENTMESSAGE,
      ResetResolutionAchievementMessageComposer,
    );
    this._composers.set(OutgoingHeader.GAMES_INIT, GetWeeklyGameRewardComposer);
    this._composers.set(
      OutgoingHeader.GETWEEKLYGAMEREWARDWINNERS,
      GetWeeklyGameRewardWinnersComposer,
    );
    this._composers.set(
      OutgoingHeader.GAME2GETACCOUNTGAMESTATUSMESSAGE,
      Game2GetAccountGameStatusMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.GAME2CHECKGAMEDIRECTORYSTATUSMESSAGE,
      Game2CheckGameDirectoryStatusMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.GAME2EXITGAMEMESSAGE,
      Game2ExitGameMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.GAME2GAMECHATMESSAGE,
      Game2GameChatMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.GAME2LOADSTAGEREADYMESSAGE,
      Game2LoadStageReadyMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.GAME2PLAYAGAINMESSAGE,
      Game2PlayAgainMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.GAME2REQUESTFULLSTATUSUPDATEMESSAGE,
      Game2RequestFullStatusUpdateMessageComposer,
    );
    this._composers.set(
      OutgoingHeader.GAME2GETWEEKLYFRIENDSLEADERBOARD,
      Game2GetWeeklyFriendsLeaderboardComposer,
    );
    this._composers.set(
      OutgoingHeader.GAME2GETWEEKLYLEADERBOARD,
      Game2GetWeeklyLeaderboardComposer,
    );
