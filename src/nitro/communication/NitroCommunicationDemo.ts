...
export class NitroCommunicationDemo
  extends NitroManager
  implements INitroCommunicationDemo
{
  ...
  private onConnectionOpenedEvent(event: Event): void {
    ...
    if (NitroConfiguration.getValue<boolean>('system.pong.manually', false))
      this.startPonging();
  ...
  private startPonging(): void {
    ...
    this._pongInterval = setInterval(
      this.sendPong,
      NitroConfiguration.getValue<number>('system.pong.interval.ms', 20000),
    );
  }
