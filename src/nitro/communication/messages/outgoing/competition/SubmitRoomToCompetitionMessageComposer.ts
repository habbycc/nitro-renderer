...
export class SubmitRoomToCompetitionMessageComposer
  implements
    IMessageComposer<
      ConstructorParameters<typeof SubmitRoomToCompetitionMessageComposer>
    >
{
  ...
  private _data: ConstructorParameters<
    typeof SubmitRoomToCompetitionMessageComposer
  >;
