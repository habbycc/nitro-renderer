...
export class PollHandler extends BaseHandler {
  constructor(connection: IConnection, listener: IRoomHandlerListener) {
    ...
    connection.addMessageEvent(
      new PollContentsEvent(this.onPollContentsEvent.bind(this)),
    );
    connection.addMessageEvent(
      new PollOfferEvent(this.onPollOfferEvent.bind(this)),
    );
    connection.addMessageEvent(
      new PollErrorEvent(this.onPollErrorEvent.bind(this)),
    );
  }
  ...
  private onPollContentsEvent(event: PollContentsEvent): void {
    ...
    const pollEvent = new RoomSessionPollEvent(
