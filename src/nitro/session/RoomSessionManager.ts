...
export class RoomSessionManager
  ...
  implements IRoomSessionManager, IRoomHandlerListener
{
  ...
  private addSession(roomSession: IRoomSession): boolean {
    ...
    this.events.dispatchEvent(
      new RoomSessionEvent(RoomSessionEvent.CREATED, roomSession),
    );
  ...
  public startSession(session: IRoomSession): boolean {
    ...
    this.events.dispatchEvent(
      new RoomSessionEvent(RoomSessionEvent.STARTED, session),
    );
  ...
  public removeSession(id: number, openLandingView: boolean = true): void {
    ...
    this.events.dispatchEvent(
      new RoomSessionEvent(RoomSessionEvent.ENDED, session, openLandingView),
    );
