  ...
  implements IRoomObjectVisualizationFactory
{
  ...
  public getVisualizationType(
    type: string,
  ): typeof RoomObjectSpriteVisualization {
    if (!type) return null;
  ...
  public getVisualizationData(
    ...
    if (
      visualizationData instanceof AvatarVisualizationData ||
      visualizationData instanceof FurnitureMannequinVisualizationData
    ) {
