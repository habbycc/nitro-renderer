...
export class RoomPlaneParser {
    ...
    while (_local_6 < _local_2) {
      ...
      while (_local_5 < _local_3) {
        ...
        if (_local_11 < 0 || _local_11 <= 0xff) {
          ...
          _local_4[_local_9 + 1][_local_10 + 1] =
            _local_13 > _local_12 ? _local_12 + 2 : _local_12 + 1;
          _local_4[_local_9 + 1][_local_10 + 2] =
            _local_14 > _local_12 ? _local_12 + 2 : _local_12 + 1;
          _local_4[_local_9 + 2][_local_10 + 1] =
            _local_15 > _local_12 ? _local_12 + 2 : _local_12 + 1;
          _local_4[_local_9 + 2][_local_10 + 2] =
            _local_16 > _local_12 ? _local_12 + 2 : _local_12 + 1;
        }
  ...
  public initializeFromTileData(k: number = -1): boolean {
    ...
    while (_local_3 < this._height) {
      ...
      while (_local_2 < this._width) {
        ...
        this._tileMatrixOriginal[_local_3][_local_2] =
          this._tileMatrix[_local_3][_local_2];
        _local_2++;
      }
      _local_3++;
    }
  ...
  private initialize(k: Point): boolean {
    ...
    if (k != null) {
      ...
      this.addFloor(
        new Vector3d(k.x + 0.5, k.y + 0.5, _local_2),
        new Vector3d(-1, 0, 0),
        new Vector3d(0, -1, 0),
        false,
        false,
  ...
  private generateWallData(k: Point, _arg_2: boolean): RoomWallData {
    ...
    while (_local_7++ < 1000) {
      ...
      _local_10 = _local_5;
      if (
        _local_6.x < this.minX ||
        _local_6.x > this.maxX ||
        _local_6.y < this.minY ||
        _local_6.y > this.maxY
      ) {
        _local_8 = true;
      }
      ...
      _local_12 =
        Math.abs(_local_11.x - _local_6.x) + Math.abs(_local_11.y - _local_6.y);
      ...
      if (
        _local_11.x == k.x &&
        _local_11.y == k.y &&
        (!(_local_11.x == _local_6.x) || !(_local_11.y == _local_6.y))
      ) {
        break;
      }
      _local_6 = _local_11;
  ...
  private hideOriginallyHiddenWalls(
    ...
    while (_local_4 < _local_3) {
      if (!k.getHideWall(_local_4)) {
        ...
        _local_7 =
          RoomWallData.WALL_DIRECTION_VECTORS[k.getDirection(_local_4)];
  ...
  private addWalls(k: RoomWallData, _arg_2: RoomWallData): void {
    ...
    while (_local_7 < _local_3) {
      if (!k.getHideWall(_local_7)) {
        ...
        const _local_20 = this.resolveOriginalWallIndex(
          _local_8,
          k.getEndPoint(_local_7),
          _arg_2,
        );
  ...
  private createWallPlanes(): boolean {
    ...
    const _local_7: number = Math.min(
      ...
      this._fixedWallHeight != -1
        ? this._fixedWallHeight
        : RoomPlaneParser.getFloorHeight(k),
    );
    ...
    while (_local_9 <= this.maxY) {
      if (
        this.getTileHeightInternal(_local_8, _local_9) >
        RoomPlaneParser.TILE_HOLE
      ) {
        _local_9--;
        break;
  ...
  private addWall(
    ...
    const _local_8: number =
      RoomPlaneParser.WALL_THICKNESS * this._wallThicknessMultiplier;
    const _local_9: number =
      RoomPlaneParser.FLOOR_THICKNESS * this._floorThicknessMultiplier;
    const _local_10: Vector3d = Vector3d.crossProduct(_arg_2, _arg_3);
    const _local_11: Vector3d = Vector3d.product(
      _local_10,
      (1 / _local_10.length) * -_local_8,
    );
    this.addPlane(
      RoomPlaneData.PLANE_WALL,
      Vector3d.sum(k, _arg_3),
      _arg_2,
      _local_11,
      [_local_10, _arg_4],
    );
    ...
    if (_arg_6) {
      ...
      if (_arg_7) {
        ...
        this.addPlane(
          ...
          Vector3d.sum(
            Vector3d.sum(k, _arg_3),
            Vector3d.product(_local_12, -1),
          ),
          _local_12,
          _local_11,
          [_local_10, _arg_2, _arg_4],
        );
      }
    }
  }
  ...
  private addFloor(
    ...
    const _local_8: RoomPlaneData = this.addPlane(
    ...
    if (_local_8 != null) {
      ...
      if (_arg_7) {
        this.addPlane(
          RoomPlaneData.PLANE_FLOOR,
          Vector3d.sum(_local_11, Vector3d.sum(_arg_2, _arg_3)),
          Vector3d.product(_arg_2, -1),
          _local_10,
        );
      }
      if (_arg_4) {
        this.addPlane(
          RoomPlaneData.PLANE_FLOOR,
          Vector3d.sum(_local_11, _arg_3),
          Vector3d.product(_arg_3, -1),
          _local_10,
        );
      }
      if (_arg_5) {
  ...
  private addPlane(
    ...
    _arg_3: IVector3D,
    _arg_4: IVector3D,
    _arg_5: IVector3D[] = null,
  ): RoomPlaneData {
    if (_arg_3.length == 0 || _arg_4.length == 0) {
      return null;
    }
    const _local_6: RoomPlaneData = new RoomPlaneData(
      k,
      _arg_2,
      _arg_3,
      _arg_4,
        ...
        if (_local_8 < 0 || _local_4[_local_6][_local_7]) {
          ...
          while (_local_9 < _local_3) {
            if (
              ...
              (_local_6 > 0 &&
                (k[_local_6 - 1][_local_9] == _local_8) == _local_12)
            ) {
              break;
            }
            _local_9++;
          ...
          _local_13 =
            _local_9 == _local_3 || !(k[_local_6][_local_9] == _local_8);
          _local_17 = false;
          ...
          while (_local_10 < _local_2 && !_local_17) {
            ...
            _local_17 =
              _local_14 ||
              (_local_7 > 0 &&
                (k[_local_10][_local_7 - 1] == _local_8) == _local_11) ||
              (_local_9 < _local_3 &&
                (k[_local_10][_local_9] == _local_8) == _local_13);
            _local_15 = _local_7;
