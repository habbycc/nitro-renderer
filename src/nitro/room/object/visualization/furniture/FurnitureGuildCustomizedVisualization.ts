...
export class FurnitureGuildCustomizedVisualization extends FurnitureAnimatedVisualization {
  ...
  protected updateModel(scale: number): boolean {
    ...
    if (this._badgeAssetNameNormalScale === '') {
      ...
      if (assetName) {
        ...
        this._badgeAssetNameSmallScale =
          this._badgeAssetNameNormalScale + '_32';
      }
    }
    ...
    this._color1 = color1
      ? color1
      : FurnitureGuildCustomizedVisualization.DEFAULT_COLOR_1;
    ...
    this._color2 = color2
      ? color2
      : FurnitureGuildCustomizedVisualization.DEFAULT_COLOR_2;
  ...
  protected getLibraryAssetNameForSprite(
    ...
    if (sprite.tag === FurnitureGuildCustomizedVisualization.BADGE) {
      return (
        '%group.badge.url%' + sprite.libraryAssetName.replace('badge_', '')
      );
    }
