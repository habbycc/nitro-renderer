...
export class AnimationFrameDirectionalData extends AnimationFrameData {
  ...
  public getX(direction: number): number {
    ...
    return this._directionalOffsets.getXOffset(
      direction,
      super.getX(direction),
    );
  }
  ...
  public getY(direction: number): number {
    ...
    return this._directionalOffsets.getYOffset(
      direction,
      super.getY(direction),
    );
  }
}
