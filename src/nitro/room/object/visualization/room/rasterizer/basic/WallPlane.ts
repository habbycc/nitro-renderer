...
export class WallPlane extends Plane {
  ...
  public render(
    ...
    const _local_8 = visualization.geometry.getScreenPoint(
      new Vector3d(0, 0, 0),
    );
    const _local_9 = visualization.geometry.getScreenPoint(
      new Vector3d(0, 0, height / visualization.geometry.scale),
    );
    const _local_10 = visualization.geometry.getScreenPoint(
      new Vector3d(0, width / visualization.geometry.scale, 0),
    );
