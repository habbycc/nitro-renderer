...
export class FloorPlane extends Plane {
  ...
  public render(
    ...
    const _local_10 = visualization.geometry.getScreenPoint(
      new Vector3d(0, 0, 0),
    );
    const _local_11 = visualization.geometry.getScreenPoint(
      new Vector3d(0, height / visualization.geometry.scale, 0),
    );
    const _local_12 = visualization.geometry.getScreenPoint(
      new Vector3d(width / visualization.geometry.scale, 0, 0),
    );
    ...
    if (_local_10 && _local_11 && _local_12) {
      ...
      const _local_15 =
        _local_10.x -
        visualization.geometry.getScreenPoint(new Vector3d(1, 0, 0)).x;
