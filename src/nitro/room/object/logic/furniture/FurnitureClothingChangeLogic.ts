...
export class FurnitureClothingChangeLogic extends FurnitureLogic {
  ...
  public initialize(asset: IAssetData): void {
    ...
    const furniData = this.object.model.getValue<string>(
  ...
  private updateClothingData(furnitureData: string): void {
    ...
    if (boyClothing && boyClothing.length)
      this.object.model.setValue<string>(
        RoomObjectVariable.FURNITURE_CLOTHING_BOY,
        boyClothing,
      );
    if (girlClothing && girlClothing.length)
      this.object.model.setValue<string>(
        RoomObjectVariable.FURNITURE_CLOTHING_GIRL,
        girlClothing,
      );
  }
  ...
  public useObject(): void {
    ...
    this.eventDispatcher.dispatchEvent(
      new RoomObjectWidgetRequestEvent(
        RoomObjectWidgetRequestEvent.CLOTHING_CHANGE,
        this.object,
      ),
    );
  }
