...
export class Matrix4x4 {
  ...
  public vectorMultiplication(k: Vector3D): Vector3D {
    const _local_2 =
      k.x * this._data[0] + k.y * this._data[3] + k.z * this._data[6];
    const _local_3 =
      k.x * this._data[1] + k.y * this._data[4] + k.z * this._data[7];
    const _local_4 =
      k.x * this._data[2] + k.y * this._data[5] + k.z * this._data[8];
  ...
  public multiply(k: Matrix4x4): Matrix4x4 {
    const _local_2 =
      this._data[0] * k.data[0] +
      this._data[1] * k.data[3] +
      this._data[2] * k.data[6];
    const _local_3 =
      this._data[0] * k.data[1] +
      this._data[1] * k.data[4] +
      this._data[2] * k.data[7];
    const _local_4 =
      this._data[0] * k.data[2] +
      this._data[1] * k.data[5] +
      this._data[2] * k.data[8];
    const _local_5 =
      this._data[3] * k.data[0] +
      this._data[4] * k.data[3] +
      this._data[5] * k.data[6];
    const _local_6 =
      this._data[3] * k.data[1] +
      this._data[4] * k.data[4] +
      this._data[5] * k.data[7];
    const _local_7 =
      this._data[3] * k.data[2] +
      this._data[4] * k.data[5] +
      this._data[5] * k.data[8];
    const _local_8 =
      this._data[6] * k.data[0] +
      this._data[7] * k.data[3] +
      this._data[8] * k.data[6];
    const _local_9 =
      this._data[6] * k.data[1] +
      this._data[7] * k.data[4] +
      this._data[8] * k.data[7];
    const _local_10 =
      this._data[6] * k.data[2] +
      this._data[7] * k.data[5] +
      this._data[8] * k.data[8];
