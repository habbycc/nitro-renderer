...
export class AvatarStructure extends EventDispatcher {
  ...
  public getBodyPartData(
    animation: string,
    frameCount: number,
    spriteId: string,
  ): AvatarAnimationLayerData {
    return this._animationManager.getLayerData(
      animation,
      frameCount,
      spriteId,
    ) as AvatarAnimationLayerData;
  }
  ...
  public maxFrames(k: IActiveActionData[]): number {
    ...
    for (const _local_3 of k) {
      _local_2 = Math.max(
        _local_2,
        this._animationData.getFrameCount(_local_3.definition),
      );
    }
    return _local_2;
  }
  ...
  public getMandatorySetTypeIds(k: string, _arg_2: number): string[] {
    ...
    this._mandatorySetTypeIds[k][_arg_2] =
      this._figureData.getMandatorySetTypeIds(k, _arg_2);
  ...
  public getActiveBodyPartIds(
    ...
    if (k.definition.isAnimation) {
      ...
      if (_local_8) {
        ...
        if (_local_8.hasAddData()) {
          ...
          for (const _local_13 of _local_8.addData) {
            const _local_6 = this._geometry.getBodyPart(
              _local_5,
              _local_13.align,
            );
      ...
      for (const _local_14 of _local_3) {
        const _local_6 = this._geometry.getBodyPartOfItem(
          _local_5,
          _local_14,
          _arg_2,
        );
  ...
  public getParts(
    ...
    if (_arg_3.definition.isAnimation) {
      ...
      if (_local_10) {
        _local_14 = this.getPopulatedArray(
          _local_10.frameCount(_arg_3.overridingAction),
        );

        for (const _local_25 of _local_10.getAnimatedBodyPartIds(
          0,
          _arg_3.overridingAction,
        )) {
          if (_local_25 === k) {
    ...
    const _local_16 = this._geometry.getParts(
      _arg_4,
      k,
      _arg_5,
      _local_9,
          ...
          if (_local_32) {
            ...
            for (const _local_33 of _local_32.parts) {
              if (_local_16.indexOf(_local_33.type) > -1) {
                ...
                const _local_13 = this._partSetsData.getPartDefinition(
                  _local_33.type,
                );

                let _local_35 = !_local_13
                  ? _local_33.type
                  : _local_13.flippedSetType;

                if (!_local_35 || _local_35 === '') _local_35 = _local_33.type;

                if (
                  _local_29 &&
                  _local_29.length > _local_33.colorLayerIndex - 1
                ) {
                  _local_36 = _local_31.getColor(
                    _local_29[_local_33.colorLayerIndex - 1],
                  );
                }
      ...
      if (!_local_38) {
        if (_local_40) {
          ...
          if (_local_9.indexOf(_local_12) > -1) {
            const _local_44 = this._geometry.getBodyPartOfItem(
              _arg_4,
              _local_12,
              _arg_7,
            );
